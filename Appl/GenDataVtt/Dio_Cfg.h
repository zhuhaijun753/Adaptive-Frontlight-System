 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dio_Cfg.h
 *   Generation Time: 2016-06-24 14:51:58
...
#define DioConf_DioChannel_env_LocalClamp15    ((Dio_ChannelType) 4) 
#define DioConf_DioChannel_env_DisplayBusAwake    ((Dio_ChannelType) 5) 
